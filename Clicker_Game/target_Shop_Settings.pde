void target_shop() {
  ...
  skinbox(300, 300, 5, 300, "White", "A special white target,", "it turns the background black", false);
  skinbox(550, 300, 6, 600, "The Sun", "A target that looks like the sun,", "[placeholder bonus]", false);
}
